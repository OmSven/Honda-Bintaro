            ...
            <div class="flex justify-between items-center h-16 sm:h-20 gap-2 sm:gap-4">
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    ...
                    <button id="notification-bell" class="relative p-1.5 sm:p-2 text-gray-500 hover:text-honda transition-colors rounded-full hover:bg-gray-50 focus:outline-none">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5.5 w-5.5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div id="sidebar-panel" class="fixed right-0 top-0 bottom-0 w-80 bg-white shadow-2xl z-50 transform translate-x-full sidebar-transition flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto py-2">
                ...
                <nav class="px-4 space-y-1">
                    ...
                    <a href="https://wa.me/6282299185425?text=Halo%20Rere,%20saya%20ingin%20booking%20test%20drive%20mobil%20Honda." target="_blank" class="block px-4 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition">Booking Test Drive</a>
            ...
            <div class="p-6 border-t border-gray-100 bg-gray-50 text-center">
                ...
                <a href="https://wa.me/6282299185425" target="_blank" class="flex items-center justify-center gap-2 w-full bg-green-500 text-white py-2.5 rounded-full hover:bg-green-600 font-bold text-sm transition">
                    <span>WhatsApp Rere</span>
                </a>
            </div>
        </div>
